# System
install.packages("cli") # cli might need an update for devtools to be installed
install.packages("devtools")    ; library("devtools")
install.packages("BiocManager") ; library("BiocManager")

#install_version("magrittr", version="1.5", upgrade="never")
...
install("microbiome", update=FALSE)
